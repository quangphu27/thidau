...
export const ERROR_VI = {
  ...
  BUZZER_EXCLUDED: 'Bạn đã sai câu này — không được nhấn chuông nữa',
  BUZZER_NOT_READY: 'Chuông chưa sẵn sàng',
  BUZZER_ALREADY_CLAIMED: 'Đã có người dành quyền trả lời',
  NO_CLAIMER: 'Chưa có ai dành quyền trả lời',
  ALREADY_REVEALED: 'Câu hỏi đã được mở chuông rồi',
